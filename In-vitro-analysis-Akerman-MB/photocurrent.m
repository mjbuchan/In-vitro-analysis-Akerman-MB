...
plot(T1, Y1(:,1), 'color', [0 0 0]+0.8, 'linewidth', 5)
 plot(T2, Y2(:,1), 'color', [0 0 0]+0.8, 'linewidth', 5)
 plot(T3, Y3(:,1), 'color', [0 0 0]+0.8, 'linewidth', 5)
 plot(T4, Y4(:,1), 'color', [0 0 0]+0.8, 'linewidth', 5)
plot(T5, Y5(:,1), 'color', [0 0 0]+0.8, 'linewidth', 5)
...
plot(T1, voltage, 'color', [0.1 0.85 1], 'linewidth', 5)
